...
public class ModelBAK {
//	private static Logger log = LogManager.getFormatterLogger(ModelBAK.class);
//
...
//
//	public ModelBAK(List<AbstractFeatureTemplate<?>> factorTemplates) {
//		this(factorTemplates, null, null);
//	}
//
//	public ModelBAK(List<AbstractFeatureTemplate<?>> factorTemplates, File modelDir, String modelName) {
...
//	}
//
//	public static ModelBAK load(final File modelBaseDir, final String modelName) {
//
...
//			in.close();
//
//			final ModelBAK m = toModel(modelWrapper, modelBaseDir, modelName);
...
//	}
//
//	private static ModelBAK toModel(SerializableModelWrapper modelWrapper, File modelBaseDir, String modelName) {
//
//		ModelBAK model = new ModelBAK(
