...
public class BeamTest extends AbstractEvaluator {
	...
	public static void main(String[] args) {
		...
		BeamTest f = new BeamTest(EEvaluationDetail.ENTITY_TYPE, 2);
	...
	public BeamTest(EEvaluationDetail slotFillingEvaluationMode, final int beamSize,
	...
	public BeamTest(EEvaluationDetail evaluationMode, final int beamSize) {
