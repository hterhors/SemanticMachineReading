 ...
 *
 */
public class SoccerPlayerSlotFillingExtraction extends AbstractSemReadProject {
	...
	public static void main(String[] args) {
		new SoccerPlayerSlotFillingExtraction();
	}

	private static Logger log = LogManager.getFormatterLogger(SoccerPlayerSlotFillingExtraction.class);
	...
	private final File slotPairConstraitsSpecifications = new File(
			"src/main/resources/soccerplayer/constraints/slotPairExclusionConstraints.csv");

	/**
	 * The directory of the corpus instances. In this example each instance is
	 * stored in its own json-file.
	 */
	private final File instanceDirectory = new File("src/main/resources/soccerplayer/corpus/instances/");
	 ...
	 */
	private final File externalNerlaAnnotations = new File("src/main/resources/soccerplayer/corpus/nerla/nerla.json");

	public SoccerPlayerSlotFillingExtraction() {
...
//				slotPairConstraitsSpecifications);
		...
		IStateInitializer stateInitializer = ((instance) -> new State(instance,
				new Annotations(new EntityTemplate(AnnotationBuilder.toAnnotation("SoccerPlayer")))));
...
//		AbstractSampler sampler = new EpochSwitchSampler(e -> new Random(e).nextBoolean());
		 ...
		 */
		final File modelBaseDir = new File("models/soccerplayer/");
		final String modelName = "soccerplayer" + new Random().nextInt(1000000);
