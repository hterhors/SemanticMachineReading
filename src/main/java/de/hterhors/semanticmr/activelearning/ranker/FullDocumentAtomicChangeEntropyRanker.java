...
public class FullDocumentAtomicChangeEntropyRanker implements IActiveLearningDocumentRanker {
	...
	final private AbstractSemReadProject runner;

	public FullDocumentAtomicChangeEntropyRanker(AbstractSemReadProject runner) {
		this.runner = runner;
	}
...
//		List<RankedInstance> objectiveInstances = new ArrayList<>();
		...
		List<SampledInstance<Instance, InstanceTemplateAnnotations, State>> results = runner
